...
function initTypewriter() {
    ...
    // Tenta pegar textos do data-attribute ou usa padrão
    const textAttr = document.querySelector('[data-typewriter-texts]');
    if (textAttr) {
        try {
            typewriterTexts = JSON.parse(textAttr.dataset.typewriterTexts);
        } catch (e) {
            console.log('Using default typewriter texts');
        }
    }
